#!/system/bin/sh
if ! applypatch -c EMMC:/dev/block/platform/13540000.dwmmc0/by-name/RECOVERY:24103200:e3d54929cc6f8e14b41a823b5f9d171db3e31f49; then
  applypatch EMMC:/dev/block/platform/13540000.dwmmc0/by-name/BOOT:19044640:92dc5b53d7bd14e0978489438a691c5cf00bac08 EMMC:/dev/block/platform/13540000.dwmmc0/by-name/RECOVERY e3d54929cc6f8e14b41a823b5f9d171db3e31f49 24103200 92dc5b53d7bd14e0978489438a691c5cf00bac08:/system/recovery-from-boot.p && log -t recovery "Installing new recovery image: succeeded" || echo 454 > /cache/fota/fota.status
else
